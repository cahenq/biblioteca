...
<?php $__env->startSection('title', 'Formulário de Empréstimo'); ?>
 <?php $__env->slot('formulario de empréstimo', null, []); ?> 
...
<div class="container">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="card-title"><?php echo e($livro->titulo); ?></h5>
            <p><strong>ISBN:</strong> <?php echo e($livro->isbn); ?></p>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="<?php echo e(route('emprestimos.buscar-livro')); ?>" class="btn btn-secondary">Voltar</a>
...
function salvarEmprestimo(event) {
    ...
    console.log({
        leitor_id: leitorId,
        livro_id: <?php echo e($livro->id); ?>,
        data_entrega: dataEntrega,
        data_devolucao: dataDevolucao
    });

    fetch("<?php echo e(route('livros.emprestar.store')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('pages.livros.administrador.layoutadm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\biblioteca\resources\views/pages/livros/administrador/formulario-emprestimo.blade.php ENDPATH**/ ?>