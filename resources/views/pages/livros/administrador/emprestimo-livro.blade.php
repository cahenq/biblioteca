...
<div class="container mt-7">
    ...
    <div id="loan-form" class="row mt-4 d-none">
        <div class="col-12">
            <form id="loan-book-form" action="{{ route('livros.emprestar') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="loan-date" name="loan_date" value="{{ date('Y-m-d') }}" readonly>
                </div>
